			   ...
			   <li>
				   <div class="row">
                     ...
                     <div class="slider-image">
                        <img src="<?php bloginfo('template_url');?>/assets/images/sliders/home-slider-image-01.png" alt="" />
                     </div>
					   </div>
				   </div>
			   </li>
            ...
            <!-- Slide -->
			   <li>
				   <div class="row">
                     ...
                     <div class="slider-image">
                        <img src="<?php bloginfo('template_url');?>/assets/images/sliders/home-slider-image-02.png" alt="" />
                     </div>
					   </div>
				   </div>
			   </li>
      ...
      <div class="row">
         ...
         <div id="portfolio-wrapper" class="bgrid-quarters s-bgrid-halves">
               ...
               <div class="item-wrap">
                     ...
                     <img alt="" src="<?php bloginfo('template_url');?>/assets/images/portfolio/geometrics.jpg">
            ...
            <div class="columns portfolio-item">
               <div class="item-wrap">
    				   <a href="portfolio.html">
                     <img alt="" src="<?php bloginfo('template_url');?>/assets/images/portfolio/console.jpg">
                     <div class="overlay"></div>
                     <div class="link-icon"><i class="fa fa-link"></i></div>
                  </a>
    					<div class="portfolio-item-meta">
            ...
            <div class="columns portfolio-item s-first">
               <div class="item-wrap">
    				   <a href="portfolio.html">
                     <img alt="" src="<?php bloginfo('template_url');?>/assets/images/portfolio/camera-man.jpg">
                     <div class="overlay"></div>
                     <div class="link-icon"><i class="fa fa-link"></i></div>
                  </a>
    					<div class="portfolio-item-meta">
            ...
            <div class="columns portfolio-item">
               <div class="item-wrap">
    				   <a href="portfolio.html">
                     <img alt="" src="<?php bloginfo('template_url');?>/assets/images/portfolio/into-the-light.jpg">
                     <div class="overlay"></div>
                     <div class="link-icon"><i class="fa fa-link"></i></div>
                  </a>
    					<div class="portfolio-item-meta">
